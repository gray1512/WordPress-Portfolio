 ...
 *
 * @uses gray_portfolio_header_style()
 */
function gray_portfolio_custom_header_setup() {
...
add_action( 'after_setup_theme', 'gray_portfolio_custom_header_setup' );

if ( ! function_exists( 'gray_portfolio_header_style' ) ) :
	/**
